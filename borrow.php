                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col px-0">
                                    <input type="text" class="form-control px-3" id="time_of_pub_book"
                                        disabled>
                                </div>
                            </div>
            ...
            <div class="fs-1 p-4">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-dark footer_btn fs-5" type="button" id="back_btn"
                        ...
                        << Back</button>
                            <button class="btn btn-success me-md-2 footer_btn fs-5" type="button" id="ok_btn_borrow"
                                onclick="ok_btn_borrow()">ยืนยัน</button>
                </div>
            </div>
        </div>
    </footer>
