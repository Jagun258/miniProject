            ...
            <div class="col-9">
                <div class="row left-top box" style="margin-bottom: 50px;padding-bottom: 0px;">
                    ...
                    <div class="col-2 my-auto">
                        <button type="button" id='search_btn' onclick="searchValue()" class="btn fw-bolder"
                            style="background-color: #086FA1;color: white">ค้นหา
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col"></div>
                            <div class="col">
                                <button type="button" class="btn btn-outline-dark mt-3 w-50 fs-5 fw-bolder" id="history"
                                    data-bs-toggle="modal" data-bs-target="#popup_history">
                                    ประวัติ
                                    <img src="https://cdn-icons-png.flaticon.com/512/565/565526.png" alt="history"
                                        width="20%" class="pb-1" />
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="popup_history" tabindex="-1" role="dialog"
                    ...
                    <button class="btn btn-dark footer_btn fs-5" type="button" id="back_btn"
                        ...
                        << Back</button>
                            <button class="btn btn-success me-md-2 footer_btn fs-5" type="button" id="ok_btn"
                                onclick="nextPage()">ยืนยัน</button>
                </div>
            </div>
        </div>
    </footer>
