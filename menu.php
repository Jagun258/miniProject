...
<body class='bg-info bg-opacity-10'>
    ...
    <div class="container text-center my-5 " style='border-radius: 25px;'>
        ...
        <div class="fs-2 mb-4">aeioustop</div>
        <div class="row">
            <button type="button" class="btn btn-menu fs-3 mx-auto" onclick="window.location.href='search.php'"> ค้นหาหนังสือ </button>
        </div>
        <div class="row">
            <button type="button" class="btn btn-menu fs-3 mx-auto" onclick="window.location.href='.html'"> บันทึกการคืนหนังสือ </button>
        </div>
        <div class="row">
            <button type="button" class="btn btn-menu fs-3 mx-auto" onclick="window.location.href='.html'"> บันทึกการยืมหนังสือ </button>
        </div>
    </div>
    <!-- --------------------- -->
